...
a minimal nullspace basis of a degree $s$ input matrix with a cost
of $O^{\sim}\left(n^{\omega}\left\lceil ms/n\right\rceil \right)$
...
If $\rho$ is the sum of $m$ largest entries of $\vec{s}$, then
