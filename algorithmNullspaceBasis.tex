...
\label{line:multiplyFP2}\STATE{$\mathbf{G}:=\mathbf{F}\mathbf{P}_{2}$;}
...
\label{line:multiplyP2N1N2}\RETURN $\left[\mathbf{P}_{1},\mathbf{P}_{2}\mathbf{N}_{1}\mathbf{N}_{2}\right],\left[\deg_{\vec{s}}\mathbf{P}_{1},\vec{v}\right]$
\end{algorithmic}
\end{algorithm}
